...
const target_api = 'api_e_contacts_sandbox';
const steps = [target_api, 'api_e_contacts_production'];

const ApiEContactsSandbox = () => (
  <Form
  ...
  >
    ...
    <ÉquipeSection />
    <CguSection
      cguLink="/docs/cgu_pcr_v1/cgu_api_e-contacts_pcr_bas_2021_v1.0.pdf"
      additionalTermsOfUse={additionalTermsOfUse}
    />
  </Form>
);

export default ApiEContactsSandbox;
